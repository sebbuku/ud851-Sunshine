...
//        String weatherForThisDay = mWeatherData[position];
        ...
        String temperatures = SunshineWeatherUtils.formatHighLows(mContext, highInCelsius, lowInCelsius);

        String weatherForThisDay = dateString + " - " + description + " - " + temperatures;
