...
public class MainActivity extends AppCompatActivity {
    ...
    private class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            URL fetchWeatherURL = NetworkUtils.buildUrl(location);
            String forecastJSONResults = null;

            try {
                forecastJSONResults = NetworkUtils.getResponseFromHttpUrl(fetchWeatherURL);

                String[] simpleJSONWeatherData = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, forecastJSONResults);
