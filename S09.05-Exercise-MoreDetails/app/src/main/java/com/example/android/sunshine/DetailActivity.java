...
//      COMPLETED (21) Implement LoaderManager.LoaderCallbacks<Cursor>
    ...
    String[] WEATHER_DETAIL_PROJECTION = {
    ...
    private static final int INDEX_WEATHER_WIND_DEGREES = 7;

    //  COMPLETED (20) Create a constant int to identify our loader used in DetailActivity
    private static final int DETAIL_LOADER_ID = 173;
...
//  COMPLETED (11) Declare TextViews for the date, description, high, low, humidity, wind, and pressure
    ...
    private TextView mWeatherDisplayHumidity;
...
//      COMPLETED (13) Find each of the TextViews by ID
        mWeatherDisplayDate = findViewById(R.id.tv_detail_weather_date);
        mWeatherDisplayDescription = findViewById(R.id.tv_detail_weather_description);
        mWeatherDisplayHighTemp = findViewById(R.id.tv_detail_weather_high_temperature);
        mWeatherDisplayLowTemp = findViewById(R.id.tv_detail_weather_low_temperature);
        mWeatherDisplayHumidity = findViewById(R.id.tv_detail_weather_humidity);
        mWeatherDisplayWind = findViewById(R.id.tv_detail_weather_wind);
        mWeatherDisplayPressure = findViewById(R.id.tv_detail_weather_pressure);
...
//      COMPLETED (17) Throw a NullPointerException if that URI is null
        if (mUri == null) {
            throw new NullPointerException("Passed Uri was null");
        }
...
//      COMPLETED (31) Display the wind speed and direction
        ...
        float windDegrees = cursor.getFloat(INDEX_WEATHER_WIND_DEGREES);
